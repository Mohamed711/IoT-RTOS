...
*****************************************************************************/
#ifdef DEBUG
static bool uartBaseValid(uint32_t ui32Base)
{
 ...
 ********************************************************************/
    ...
    {
    		if(ppui32UARTIntMap[ui8Idx][0] == ui32Base) /* See if this base address matches.*/
    		{
    			return(ppui32UARTIntMap[ui8Idx][1]); /*Return the corresponding interrupt number.*/
    		}
    }

    return(0); /*The base address could not be found, so return an error.*/
}
...
* - \b UART_OUTPUT_RTS - The modem control RTS signa
